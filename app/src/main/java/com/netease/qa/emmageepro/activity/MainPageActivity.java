...
import com.netease.qa.emmageepro.service.EmmageeService;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnTest.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkPermission()) {
                    Toasty.info(MainPageActivity.this, "Permission Granted ", Toast.LENGTH_LONG, true).show();
                } else {
                    Toasty.info(MainPageActivity.this, "Have no permission ", Toast.LENGTH_LONG, true).show();
                }
