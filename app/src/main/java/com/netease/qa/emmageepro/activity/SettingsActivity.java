...
public class SettingsActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        checkUpgradeButton = findViewById(R.id.setting_checkUpdate);
        ...
        checkUpgradeButton.setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View view) {
                Toasty.warning(getApplicationContext(), getString(R.string.check_upgrade), Toast.LENGTH_SHORT, true).show();
                Beta.checkUpgrade();
            }
        });
    }
